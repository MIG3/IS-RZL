...
namespace Ф_ИС_ЕРЗ
{
    ...
    public partial class ИС_ЕРЗEntities2 : DbContext
    {
        public ИС_ЕРЗEntities2()
            : base("name=ИС_ЕРЗEntities2")
        {
        }
        ...
        public virtual int Изменение_паспорта(Nullable<int> flag, string имя, string фамилия, string отчество, string новИмя, string новФамилия, string новОтчество, string серия_паспорта, string номер_паспорта)
        {
            var flagParameter = flag.HasValue ?
                new ObjectParameter("flag", flag) :
                new ObjectParameter("flag", typeof(int));
            ...
            var новИмяParameter = новИмя != null ?
                new ObjectParameter("НовИмя", новИмя) :
                new ObjectParameter("НовИмя", typeof(string));
    
            var новФамилияParameter = новФамилия != null ?
                new ObjectParameter("НовФамилия", новФамилия) :
                new ObjectParameter("НовФамилия", typeof(string));
    
            var новОтчествоParameter = новОтчество != null ?
                new ObjectParameter("НовОтчество", новОтчество) :
                new ObjectParameter("НовОтчество", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Изменение_паспорта", flagParameter, имяParameter, фамилияParameter, отчествоParameter, новИмяParameter, новФамилияParameter, новОтчествоParameter, серия_паспортаParameter, номер_паспортаParameter);
        }
    }
}
